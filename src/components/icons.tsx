/**
 * Brand glyphs (GitHub, LinkedIn). Single-path marks drawn with `currentColor`
 * so they inherit the surrounding text/button color and theme correctly.
 * Decorative by default (`aria-hidden`); the labelled control provides the name.
 */
